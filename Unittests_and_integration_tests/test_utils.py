...
class TestMemoize(unittest.TestCase):
    ...
    ensuring that the method is only called once even if accessed multiple
    times. This test suite verifies that the memoize decorator works correctly
    ...
    def test_memoize(self):
        ...
        Mocks:
        TestClass.a_method to vrify its called only once.
        """
